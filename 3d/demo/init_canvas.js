...
function parsePointCloud(){
    ...
    if(pointcloud_msg.data.buffer){
        ...
        // console.log("false:",pointcloud_msg.info.height,pointcloud_msg.info.width,pointcloud_msg.data)
        // buffer = pointcloud_msg.data
    }
    var dv = new DataView(buffer);

    points_size = 0;
    for(var i=0;i<pointcloud_msg.info.width*pointcloud_msg.info.height;i=i+skip)
    {
